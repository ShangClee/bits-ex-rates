...
const currencies = {
    'usd': { name: 'US Dollar', symbol: ''South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
...
fetchRates();, flag: '🇺🇸', amount: 1 },
    ...
    'aud': { name: 'Australian Dollar', symbol: 'A'South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
    'twd': { name: 'Taiwan Dollar', symbol: 'NT$', flag: '🇹🇼', amount: 10 }
};
...
// Initial load
fetchRates();, flag: '🇦🇺', amount: 1 },
    'cad': { name: 'Canadian Dollar', symbol: 'C'South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
    'twd': { name: 'Taiwan Dollar', symbol: 'NT$', flag: '🇹🇼', amount: 10 }
};
...
fetchRates();, flag: '🇨🇦', amount: 1 },
    ...
    'nzd': { name: 'New Zealand Dollar', symbol: 'NZ'South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
    'twd': { name: 'Taiwan Dollar', symbol: 'NT$', flag: '🇹🇼', amount: 10 }
};
...
// Initial load
fetchRates();, flag: '🇳🇿', amount: 1 },
    'mxn': { name: 'Mexican Peso', symbol: ''South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
    'twd': { name: 'Taiwan Dollar', symbol: 'NT$', flag: '🇹🇼', amount: 10 }
};
...
// Initial load
fetchRates();, flag: '🇲🇽', amount: 10 },
    'sgd': { name: 'Singapore Dollar', symbol: 'S'South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
    'twd': { name: 'Taiwan Dollar', symbol: 'NT$', flag: '🇹🇼', amount: 10 }
};
...
// Initial load
fetchRates();, flag: '🇸🇬', amount: 1 },
    'hkd': { name: 'Hong Kong Dollar', symbol: 'HK'South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
    'twd': { name: 'Taiwan Dollar', symbol: 'NT$', flag: '🇹🇼', amount: 10 }
};
...
fetchRates();, flag: '🇭🇰', amount: 10 },
    ...
    'brl': { name: 'Brazilian Real', symbol: 'R'South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
    'twd': { name: 'Taiwan Dollar', symbol: 'NT$', flag: '🇹🇼', amount: 10 }
};
...
fetchRates();, flag: '🇧🇷', amount: 1 },
    ...
    'twd': { name: 'Taiwan Dollar', symbol: 'NT'South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
    'twd': { name: 'Taiwan Dollar', symbol: 'NT$', flag: '🇹🇼', amount: 10 }
};
...
function showMainTab(tabId) {
    ...
    // Update display if we have rates
    if (Object.keys(currentRates).length > 0) {
        displayCurrentMainTab();
    }
}

function showPage(pageId) {
    // Hide all pages within BTS tab
    document.querySelectorAll('.page').forEach(page => {
        page.classList.remove('active');
    });
...
function hideAllContainers() {
    ...
    document.getElementById('fiatPerBitsContainer').style.display = 'none';
    document.getElementById('bitsPerFiatContainer').style.display = 'none';
    document.getElementById('stsContainer').style.display = 'none';
}

function displayCurrentMainTab() {
    switch(currentMainTab) {
        case 'btc':
            displayBitcoinRates(currentRates);
            break;
        case 'bts':
            displayCurrentBtsPage();
            break;
        case 'sts':
            displaySatoshiRates(currentRates);
            break;
    }
}
...
function displayBitcoinRates(bitcoinRates) {
    const container = document.getElementById('btcContainer');
    container.innerHTML = '';

    Object.entries(currencies).forEach(([code, config]) => {
        if (bitcoinRates[code]) {
            const bitcoinPrice = bitcoinRates[code];
            const rateCard = createBitcoinCard(code, config, bitcoinPrice);
            container.appendChild(rateCard);
        }
    });
...
function displaySatoshiRates(bitcoinRates) {
    ...
    Object.entries(currencies).forEach(([code, config]) => {
        if (bitcoinRates[code]) {
            ...
            const rateCard = createSatoshiCard(code, config, satoshiRate);
            container.appendChild(rateCard);
        }
    });
...
function createBitcoinCard(currencyCode, config, rate) {
    const card = document.createElement('div');
    card.className = 'rate-card';
    ...
    card.innerHTML = `
        <div class="currency-info">
            <span class="currency-flag">${config.flag}</span>
            <div>
                <div class="currency-name">1 Bitcoin</div>
                <div style="font-size: 12px; color: #666;">${currencyCode.toUpperCase()}</div>
            </div>
        </div>
        <div class="rate-value">
...
function createSatoshiCard(currencyCode, config, rate) {
    const card = document.createElement('div');
    card.className = 'rate-card';
    
    // Format satoshi rate with appropriate decimal places
    let formattedRate;
    if (rate >= 1) {
...
// Initial load
fetchRates();'South Korean Won', symbol: '₩', flag: '🇰🇷', amount: 1000 },
    'twd': { name: 'Taiwan Dollar', symbol: 'NT$', flag: '🇹🇼', amount: 10 }
};
